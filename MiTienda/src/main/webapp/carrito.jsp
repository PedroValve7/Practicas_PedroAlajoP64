<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" session="true" import="java.util.List, java.util.ArrayList, java.text.DecimalFormat, java.sql.SQLException, com.productos.negocio.*"%>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <nav>
        <a href="menu_comprador.jsp"><img src="images/home.png" alt="Home"> Inicio</a>
    </nav>
    ...
    <footer>
        <ul>
            <li><a href="https://www.facebook.com/pedrovinicio.alajo"><img src="images/facebook.png" alt="Facebook"></a></li>
