...
<body>
	...
	String colorfav= request.getParameter("color"); out.print("Su nombre es: "+nombre + "</br>");
	out.print("Su cedula es: "+cedula + "</br>");
	out.print("Su estado civil es: "+ estadocivil + "</br>"); out.print("Su lugar de residencia es: "+ lresidencia + "</br>");
